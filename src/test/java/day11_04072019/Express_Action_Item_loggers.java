...
public class Express_Action_Item_loggers extends Reusable_Methods_Loggers {
    ...
    public void openBrowser() throws IOException, BiffException, InterruptedException {
       ...
       //define the writable sheet to write back later
        ...
        //define the path of the Extent report folder here
    ...
    public void expressCheckout() throws InterruptedException, WriteException, IOException {
        ...
        for(int i = 1; i<=1;i++){
            ...
            click(driver,logger,"//*[contains(text(),'Shop by Style')]",0,"Shop by Style Link");
