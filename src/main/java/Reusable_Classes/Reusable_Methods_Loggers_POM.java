...
public class Reusable_Methods_Loggers_POM {
    ...
    public static void input(WebDriver driver, ExtentTest logger, WebElement locator, int index, String userInput,String elementName) throws IOException {
        WebDriverWait wait = new WebDriverWait(driver,timeOut);
    ...
    public static String getText(WebDriver driver, ExtentTest logger,WebElement locator, int index, String elementName) throws IOException {
        String result = null;
        WebDriverWait wait = new WebDriverWait(driver,timeOut);
